...
data_flat$station <- ifelse(data_flat$SurveyAreaIdentifier == "" | nchar(data_flat$SurveyAreaIdentifier) >15 , sub(".*?-","", data_flat$SamplingEventIdentifier), data_flat$SurveyAreaIdentifier)
...
write.csv(out_translated, "E:/MelinaStuff/BAM/dataImport/out/WT_NCATLAScombined_20220211.csv")
